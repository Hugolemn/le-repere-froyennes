...
const menuItems: Record<Category, { name: string; desc: string; price: string }[]> = {
  ...
  salades: [
    { name: "La Pêche mer", desc: "Pêche, thon", price: "8,50 €" },
    { name: "La Boulette", desc: "Tranches de boulette", price: "8,50 €" },
    { name: "La Pomme d'Or", desc: "Brie, pomme, œufs, miel", price: "8,50 €" },
    { name: "La Chèvre d'Or", desc: "Chèvre, pomme, œufs, miel", price: "8,50 €" },
    { name: "L'Italienne", desc: "Rosette, olives, copeaux de parmesan, tomates séchées, pesto", price: "9,00 €" },
    { name: "La Saumon", desc: "Saumon, avocat", price: "9,00 €" },
    { name: "La Burrata", desc: "Burrata, jambon de Parme, olives, tomates séchées", price: "9,00 €" },
    { name: "La Grecque", desc: "Fêta", price: "9,00 €" },
  ],
  pates: [
